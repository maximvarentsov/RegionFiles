...
public class Tag {
	...
	/**
	 * Create a new TAG_List with an empty list. Use {@link com.mojang.Tag#addTag(com.mojang.Tag)} to add tags later.
	 * 
	 ...
	 * 
	 * @param type any value from the {@link com.mojang.Tag.Type} enum.
	 * @param name name for the new tag or null to create an unnamed tag.
	 * @param value an object that fits the tag type or a {@link com.mojang.Tag.Type} to create an empty TAG_List with this list type.
	 */
	 ...
	 * @throws java.io.IOException if this is not a valid NBT structure or if any IOException occurred.
	 */
